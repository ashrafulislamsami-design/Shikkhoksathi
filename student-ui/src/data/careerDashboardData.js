// JavaScript version of careerDashboardData for compatibility

export const calculateGap = (current, target) => {
  return target - current;
};

export const getPriority = (gap) => {
...
export const skillMetrics = mockCareerData.skills;
export const careerRoadmap = mockCareerData.roadmap;
